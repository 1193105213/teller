    ...
    if(validarUrl === '') {
        resultado.innerHTML += `
            ...
            ${description === "" ? "Sin descripcion" : description}
                ...
                <a class=" sm:text-sm block w-full bg-yellow-800 hover:bg-lime-500 text-white uppercase font-bold text-center rounded mt-5 p-1"  href="teller/Marvel-api/html/stories.html?stories=${id}" target="_blank" rel="noopener noreferrer">Ver Stories</a>
            </div>
            </div>
            </div>
